...
(defprotocol DataSourceProtocol
  ...
  (parties [source query]
    "Returns a paginated list of parties.  The query map contains
    parameters (with string keys) and is compliant with /parties
    endpoint as described by iSHARE Satellite Role.  Note that this
    query also includes pagination parameters."))
